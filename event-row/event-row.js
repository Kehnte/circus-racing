// Store SVGs to inject dynamically
const icons = {
    "fastest-lap": `
...
/**
 * Updates the race event row with the desired status and optional time
 * @param {string} status - 'fastest-lap', 'incident', or 'finished'
 * @param {string} timeValue - e.g., '01:23.456' (ignored for 'incident')
 */
function setEventStatus(status, timeValue = "00:00.000") {
...
// TEST AREA : uncomment below to test

/*
setTimeout(() => {
    setEventStatus('incident');
}, 2000);

setTimeout(() => {
    setEventStatus('finished', '01:04.298');
}, 4000);
*/
